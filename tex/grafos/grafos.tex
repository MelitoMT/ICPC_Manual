...
\begin{enumerate}
    ...
    \item Entre todo par de vértices existe exactamente un camino.
\end{enumerate}
...
Tomemos un árbol más grande que el anterior y tomemos su centroide $c$. Al eliminarlo, el árbol se divide en varias componentes, cada una de tamaño $\leq \lfloor n/2 \rfloor$. Nótese que entonces cualquier camino de un vértice $v$ en una componente a otro $u$ en otra componente, este pasa por $c$. Por tanto, la distancia entre $u$ y $v$ la podemos calcular como la suma de la distancia entre $c$ y $v$ y la distancia entre $c$ y $u$.
