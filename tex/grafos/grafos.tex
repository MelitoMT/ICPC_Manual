...
En toda gráfica, el número de vértices de grado impar es par.
\\\\
$Demostración$.
...
Un \textbf{árbol} es una gráfica conexa (es decir, entre cualquier par de vértices existe un camino) y sin ciclos. Esta definición es solo una de varias caracterizaciones equivalentes, todas igualmente válidas como definición y útiles en distintos contextos.
