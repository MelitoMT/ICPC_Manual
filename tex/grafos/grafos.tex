...
En una gráfica \textbf{no dirigido}, la conectividad es simple, hay un
camino entre dos vértices o no. Pero en una gráfica \textbf{dirigido} la
...
Para un gráfica $G$ con $n$ vértices, las siguientes afirmaciones son equivalentes:
\begin{enumerate}
...
\\\\
Ver \codelink{https://github.com/MelitoMT/ICPC_Manual/tree/master/tex/codes/editorial/808F.cpp}.
