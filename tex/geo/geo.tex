...
\\\\
Recordemos que hay varias formas de representar a las líneas del plano, una de ellas es de la forma $p+tv$ donde $p$ es un punto de la línea, $t$ un escalar y $v$ un vector director, teniendo dos líneas de expresadas de esta forma podemos encontrar su intersección 
%revisar interseccion de lineas
%interseccion de segmentos
%interseccion de circulo con linea
